...
Special thanks to Sean for creating the original Markdownizr Chrome extension and releasing it to the public domain, which inspired this standalone web application.
